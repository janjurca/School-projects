\hypertarget{classQCPLayout}{}\section{Dokumentace třídy Q\+C\+P\+Layout}
...
Creates an instance of \hyperlink{classQCPLayout}{Q\+C\+P\+Layout} and sets default values. 

Note that since \hyperlink{classQCPLayout}{Q\+C\+P\+Layout} is an abstract base class, it can\textquotesingle{}t be instantiated directly. 
...
Finally calls \hyperlink{classQCPLayout_a41e6ac049143866e8f8b4964efab01b2}{simplify} to make sure all empty cells are collapsed.
...
\end{DoxySeeAlso}
\hypertarget{classQCPLayout_a4115014e4c4ccbac2477405c994b2392}{}\index{Q\+C\+P\+Layout@{Q\+C\+P\+Layout}!element\+At@{element\+At}}
\index{element\+At@{element\+At}!Q\+C\+P\+Layout@{Q\+C\+P\+Layout}}
\subsubsection[{element\+At(int index) const  =0}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Q\+C\+P\+Layout\+Element} $\ast$ Q\+C\+P\+Layout\+::element\+At (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{classQCPLayout_a4115014e4c4ccbac2477405c994b2392}
...
\begin{DoxySeeAlso}{Viz také}
\hyperlink{classQCPLayout_a51fe2675b53e829130b229bc1f7b0f99}{elements}, \hyperlink{classQCPLayout_ac2a4553f13cc91ed9eaf62d757752696}{element\+Count}, \hyperlink{classQCPLayout_a5a79621fa0a6eabb8b520cfc04fb601a}{take\+At} 
\end{DoxySeeAlso}


Implementováno v \hyperlink{classQCPLayoutInset_ab096d07b08f9b5455647f3ba7ff60e27}{Q\+C\+P\+Layout\+Inset} a \hyperlink{classQCPLayoutGrid_a26849ee5c47b4c940e8d65e8462f1065}{Q\+C\+P\+Layout\+Grid}.

\hypertarget{classQCPLayout_ac2a4553f13cc91ed9eaf62d757752696}{}\index{Q\+C\+P\+Layout@{Q\+C\+P\+Layout}!element\+Count@{element\+Count}}
\index{element\+Count@{element\+Count}!Q\+C\+P\+Layout@{Q\+C\+P\+Layout}}
\subsubsection[{element\+Count() const  =0}]{\setlength{\rightskip}{0pt plus 5cm}int Q\+C\+P\+Layout\+::element\+Count (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{classQCPLayout_ac2a4553f13cc91ed9eaf62d757752696}


Returns the number of elements/cells in the layout. 

\begin{DoxySeeAlso}{Viz také}
\hyperlink{classQCPLayout_a51fe2675b53e829130b229bc1f7b0f99}{elements}, \hyperlink{classQCPLayout_a4115014e4c4ccbac2477405c994b2392}{element\+At} 
\end{DoxySeeAlso}


Implementováno v \hyperlink{classQCPLayoutInset_a2087b97b9266fd9e0f571a8d3cf709f9}{Q\+C\+P\+Layout\+Inset} a \hyperlink{classQCPLayoutGrid_aa682b1d36660478f665bab3c64e956a9}{Q\+C\+P\+Layout\+Grid}.
...
\subsubsection[{elements(bool recursive) const }]{\setlength{\rightskip}{0pt plus 5cm}Q\+List$<$ {\bf Q\+C\+P\+Layout\+Element} $\ast$ $>$ Q\+C\+P\+Layout\+::elements (
\begin{DoxyParamCaption}
\item[{bool}]{recursive}
\end{DoxyParamCaption}
...
Reimplementováno v \hyperlink{classQCPLayoutGrid_ae9e24e01552f6667b6d05b12a54a4caa}{Q\+C\+P\+Layout\+Grid}.
...
\subsubsection[{remove(\+Q\+C\+P\+Layout\+Element $\ast$element)}]{\setlength{\rightskip}{0pt plus 5cm}bool Q\+C\+P\+Layout\+::remove (
\begin{DoxyParamCaption}
...
\subsubsection[{remove\+At(int index)}]{\setlength{\rightskip}{0pt plus 5cm}bool Q\+C\+P\+Layout\+::remove\+At (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
...
Reimplementováno v \hyperlink{classQCPLayoutInset_abb9eb23bf2d7c587a8abe02d065eae0a}{Q\+C\+P\+Layout\+Inset} a \hyperlink{classQCPLayoutGrid_a08bba60e4acd20165526a8fd7f986b58}{Q\+C\+P\+Layout\+Grid}.
...
\subsubsection[{size\+Constraints\+Changed() const }]{\setlength{\rightskip}{0pt plus 5cm}void Q\+C\+P\+Layout\+::size\+Constraints\+Changed (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{take(\+Q\+C\+P\+Layout\+Element $\ast$element)=0}]{\setlength{\rightskip}{0pt plus 5cm}bool Q\+C\+P\+Layout\+::take (
\begin{DoxyParamCaption}
\item[{{\bf Q\+C\+P\+Layout\+Element} $\ast$}]{element}
\end{DoxyParamCaption}
...
Implementováno v \hyperlink{classQCPLayoutInset_a9ac707ccff650633b97f52dd5cddcf49}{Q\+C\+P\+Layout\+Inset} a \hyperlink{classQCPLayoutGrid_a666a9fe9e92054436f9b66eba25cca0c}{Q\+C\+P\+Layout\+Grid}.
...
\subsubsection[{take\+At(int index)=0}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Q\+C\+P\+Layout\+Element} $\ast$ Q\+C\+P\+Layout\+::take\+At (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
...
\begin{DoxySeeAlso}{Viz také}
\hyperlink{classQCPLayout_a4115014e4c4ccbac2477405c994b2392}{element\+At}, \hyperlink{classQCPLayout_ada26cd17e56472b0b4d7fbbc96873e4c}{take} 
\end{DoxySeeAlso}


Implementováno v \hyperlink{classQCPLayoutInset_ad6756a3b507e20496aaf7f5ca16c47d1}{Q\+C\+P\+Layout\+Inset} a \hyperlink{classQCPLayoutGrid_acc1277394ff8a6432e111ff9463e6375}{Q\+C\+P\+Layout\+Grid}.
...
\subsubsection[{update(\+Update\+Phase phase)}]{\setlength{\rightskip}{0pt plus 5cm}void Q\+C\+P\+Layout\+::update (
\begin{DoxyParamCaption}
